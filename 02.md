...
1. A pop-up appears stating **Trying to open Visual Studio Code**. Click **Open** to continue..
...
1. On Visual Studio Code pop up, click on **Install and Open**.
   ...
   >**Note:** If the update pop up appears, click on update and wait for relaunch of vs code.

   >**Note:** The update may take some time. Check again after 10–15 minutes. If Visual Studio Code does not restart automatically, open Settings, select Check for Updates, and install any available updates from there.
...
1. On the **Sign into Microsoft Azure** tab, as you have already signed in to azure portal, select your account from the list.
   ...
   >**Note:** If account is not visible, re-enter the Email and Temporary Access Pass from the environment tab.
...
1. On the **Visual Studio Code** tab, click on **Allow**.
...
1. Select **Azure (1)** from the left-menu, expand **Resources (2)** from Azure extension, then expand Azure subscription > App services and right-click on **openaiwebapp<inject key="DeploymentID" enableCopy="false"/> (3)** then click on **Deploy to Web App (4)**.
...
1. Navigate to the path **/home/azureuser/cloudfiles/code/Users/odl_user_<inject key="DeploymentID" enableCopy="false"/>/artifacts/openai-model/ (1)** and click on **Select (2)**.
