...
1. On the Deploy model text-embedding-ada-002 pop-up enter the deployment name as **ada002 (1)** and scale down the **Tokens per Minute Rate Limit (thousands) (2)** to **11k** then click on **Deploy (3)**.
   ...
   >**Note:** If you don't see the option to scale down token, click on Customize. 
...
1. Run each cell one after the other and observe the output.
   ...
   > **Note**: If you encounter any errors, please re-run the cell or restart the kernel by following these steps, click the **ellipses (...) icon** (1), select **restart kernel** (2), click **clear all outputs** (3), and then try running all the cells again from beginning.
